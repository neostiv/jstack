          ...
          <div className="grid gap-4 lg:grid-cols-3 lg:grid-rows-2">
            ...
            <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] ">
                ...
                <div className="flex flex-1 items-center justify-center px-8 max-lg:pb-12 max-g:pt-10 sm:px-10 lg:pb-32">
                  <Image
                    className="w-full max-lg:max-w-xs"
              ...
              <div className="pointer-events-none absolute inset-px rounded-g shadow ring-1 ring-black/5" />
            </div>

            <div className="relative lg:row-span-2">
              <div className="absolute inset-px rounded-lg bg-white max-lg:rounded-b-[2rem] lg:rounded-r-[2rem]" />
              <div className="relative flex h-full flex-col overflow-hidden rounded-[cal(theme(borderRadius.lg)+1px)] max-lg:rounded-b-[calc(2rem+1px)] lg:rounded-r-[calc(2rem+1px)]">
                <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
                  <p className="mt-2 text-lg/7 font-medium tracking-tight text-brand-950 max-lg:text-center">
                    Seamless Integration
                  </p>
                  <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                    Konnect PeeengPanda with your existing workflows in minutes
