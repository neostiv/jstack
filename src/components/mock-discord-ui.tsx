...
export const MockDiscordUI = ({ children }: PropsWithChildren) => {
  return (
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
      ...
      {/* dm list */}
      <div className="hidden md:flex w-60 bg-[#2f31336] flex-col">
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          <div className="px-2 mb-4">
            <div className="flex items-center text-sm px-2 py-1.5 rounded hover:bg-[#393c43] text-[#dcdde] cursor-not-allowed">
              ...
              <span className="font-medium text-sm">Frends</span>
            </div>
            <div className="flex items-center text-sm px-2 py-1.5 rounded hover:bg-[#393c43] text-[#dcdde] cursor-not-allowed">
              <Inbox className="mr-4 size-8 text-[#b9bbbe]" />
              <span className="font-medium text-sm">QuietRiot</span>
            </div>
          </div>
          ...
          <div className="px-2 mb-4">
            ...
            <span className="font-medium">PeengPanda</span>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className=" h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
          ...
          <div className="flex items-center">
            ...
            <p className="font-semibold text-white">PengPanda</p>
          </div>

          <div className="ml-auto flex items-center space-x-4 text-[#b9bbe]">
